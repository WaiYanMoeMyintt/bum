  ...
  return (
    <div className="mt-5 px-1">
      ...
      <div className="general_list flex flex-col gap-6 mt-4">
        <div
          onClick={() => setHover(5)}
          className={`flex items-center justify-between gap-2 py-2.5 px-4 rounded-lg cursor-pointer ${
        ...
        >
          ...
          <div className="flex items-center gap-1">
            <Image
              src="/dots.svg"
              alt="dots"
              className={`cursor-pointer ${hover === 5 ? "block" :"hidden"}`}
              width={20}
              height={20}
            />
          </div>
        ...
        <div
          onClick={() => setHover(6)}
          className={`flex items-center justify-between gap-2 py-2.5 px-4 rounded-lg cursor-pointer ${
            hover === 6 ? "bg-white shadow-sm transition-all" : "bg-transparent"
          }`}
        >
           <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <Image
              src="/dots.svg"
              alt="dots"
              className={`cursor-pointer ${hover === 6 ? "block" :"hidden"}`}
              width={20}
              height={20}
            />
          </div>
