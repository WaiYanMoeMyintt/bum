  ...
  return (
    <div className="px-4 py-2.5 mt-8 card_title">
      <div className = "text-center">
        <h3 className = "mb-5 text-2xl font-bold">Explore all <span className = "intro">BumBum</span> has to offer</h3>
      </div>
      ...
      <div className  = "profile-title mt-8 w-full flex flex-col gap-4 items-center justify-center text-center ">
          <h2 className = "sm:text-2xl lg:text-3xl  font-bold">'Habits makes it easy to go as simple or as complex as you want'</h2>
